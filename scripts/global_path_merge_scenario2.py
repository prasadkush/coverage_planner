...
with open("path_rrt_test_scenario2.txt", "r") as ins:
  path_global_1 = []
  for line in ins:
    path_global_1.append([float(line) for line in line.split()])

with open("path_rrt_reset_test_scenario2.txt", "r") as ins:
  path_global_2 = []
  for line in ins:
...
with open("path_rrt_land_test_scenario2.txt", "r") as ins:
  path_global_3 = []
  for line in ins:
...
f = open("path_global_scenario2.txt",'w')
